...
return [
    ...
    */
    ...
    'label_reset_without_admin' => env('APP_RESET_LABEL', false), //can the label be reset by users other than admin
    'label_reprint_without_code' => env('APP_REPRINT_LABEL', false), //can the label be reprinted without using code
