                ...
                <div class="prescriptionStats flex-center">
                    ...
                    <div class="list">
                        <ul v-if="loaded">
                            ...
                            <li v-if="appInfo.delivery_companies.includes('dpd')">
                                <span>DPD</span>{{ statistics.dpd }}
                            </li>
                            <li v-if="appInfo.delivery_companies.includes('ups')">
                                <span>UPS</span>{{ statistics.ups }}
                            </li>
                            <li v-if="appInfo.delivery_companies.includes('dhl')">
                                <span>DHL</span>{{ statistics.dhl }}
                            </li>
                            <li v-if="appInfo.delivery_companies.includes('rml')">
