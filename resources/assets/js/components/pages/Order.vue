                    ...
                    <div style="width: 100%; display:flex; justify-content:center; align-items:center;">
                        <div style="display:flex; justify-content:center; align-items:center;" v-if="orderDetails.DeliveryID == '7' || orderDetails.DeliveryID == '10'
                            ...
                            <button @click="reset()" :disabled="requestedPrint"
                                v-if="!isManual && (orderDetails.TrackingCode != '' && orderDetails.TrackingCode != null) && (userInfo.role >= 60 || appInfo.label_reset_without_admin)"
...
export default {
        ...
        apiEndpoint() {
            if (this.orderDetails != null) {
                if (this.orderDetails.DeliveryID == '10') {
                    return '/shipment-validation/' + this.orderDetails.PrescriptionID;
    ...
    methods: {
                    ...
                    axios.get(this.apiEndpoint)
                        .then((response) => {
                            ...
                            if (response.data.data.gif) {
                                ...
                                this.printPage(this.labelEndpoint, true);
                            }
        ...
        authorize(callback) {
            if (this.appInfo.label_reset_without_admin) {
                let reasons = {
                ...
                this.$swal({
                    ...
                    if (result.value) {
                        callback();
                        axios.post('/log-reprint', { orderID: this.currentOrderID, reason: reasons[result.value], code: 'Not Required' })
                            .then((response) => {
